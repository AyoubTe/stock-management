 ...
 * @author hp
 */
public class RetirerStock extends HttpServlet {
...
@EJB
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
            out.println("<h2>Retiré un élément du stock: </h2>");
            ...
            out.println("</br>");
            out.println("Element du stock: ");
            out.println("<select name = \"refProduit\" id=\"NomProduit\">");
            out.println("</select>");
            
            out.println("</br>");
            out.println("<button  type = \"submit\">Retirer élément</button>");
            out.println("</form>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Supprimer élément Stock</title>");
            ...
            boolean deleted = stockFacade.supprimerElementStock(nomStock, refProduit);
            
            if(deleted){
                out.println("<div class='alert alert-success'>L'élément a été retiré avec succès!!</div>");
            } else{
                out.println("<div class='alert alert-dangetr'>Une erreur se produite!!</div>");
            }
